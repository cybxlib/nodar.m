...
направлениях, то вы действительно могли бы определить систему, подобную этой: $\func{dV{dl}$ dV /dl = Fv(l)u^v(l), dN /dl = Fn(l)u^n(l), dB /dl = Fb(l)u^b(l) - скалярные функции, 
