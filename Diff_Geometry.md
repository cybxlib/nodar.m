...
направлениях, то вы действительно могли бы определить систему, подобную этой: $\dfrac{dV}{dl} = F_v(l)$ dV /dl = Fv(l)u^v(l), $\dfrac{dV}{dl}$dN /dl = Fn(l)u^n(l), $\dfrac{dV}{dl}$dB /dl = Fb(l)u^b(l) - скалярные функции, 
